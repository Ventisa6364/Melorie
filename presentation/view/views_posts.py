...
from presentation.forms.forms_posts import PostForm
from domain.recommendations.recs import get_recomended_posts
...
def post_detail(request, post_slug):
    ...
    return render(request, 'posts/post/post_detail.html', {'post': post, 'total_likes': total_likes, 'total_saves': total_saves, 'recommendations': recommendations,}) 
...
def post_create(request):
    ...
    return render(request, 'posts/post/post_create.html', {'form': form,})
