...
from presentation.forms.forms_users import CustomProfileCreationForm, CustomProfileAuthenticationForm, CustomProfileUptadeForm
...
def logout_view(request):
  logout(request)
  if request.headers.get('HX-Request'):
    return HttpResponse(headers={'HX-Redirect': reverse('posts:home_page')})
  return redirect('posts:home_page')
